...
const settings = ['Home', 'About', 'Support'];
...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="static" sx={{backgroundColor:"white",color:'black',boxShadow:'none',textDecoration:'none'}}>
            ...
            >
              {pages.map((page) => (
               <Link key={page.name} to={page.path} >
                 <MenuItem  onClick={handleCloseNavMenu} sx={{textDecoration:'none'}}>
